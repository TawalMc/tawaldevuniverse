...
It's let's say the same thing which will happen if your data is bigger than your data types: it `cut-off`.
...
Because, `millis()` can return a value like `120'000` which equals to `2 (minutes)`. So imagine you try to store
