...
It's let's say the samething which we'll happen if your data is bigger than your data types: it `cut-off`.
...
each second (less than 01 second) the program execute this if statement body...
