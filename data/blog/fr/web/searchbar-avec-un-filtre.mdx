...
Le rendu final peut être testé sur StackBlitz. [![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/edit/searchbarwithselectandfilter?file=src/component/SearchbarWithSelectAndFilter/index.tsx)
...
`component/SearchbarWithSelectAndFilter/index.tsx`
...
`SearchbarWithSelectAndFilter/index.tsx`
